<h2><a href="https://practice.geeksforgeeks.org/problems/simple-interest3457/1?page=4&difficulty[]=-2&status[]=unsolved&sortBy=submissions">Simple Interest</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given three integers P,R and T, denoting Principal, Rate of Interest and Time period respectively.Compute the simple Interest.</span></p>
